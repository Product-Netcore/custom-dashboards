...
export const customDashboards: Dashboard[] = [
  allChartsDashboard,
  {
    ...
    type: 'custom' as DashboardType,
    charts: [
      { id: 'chart-1', title: 'Sample Funnel Analysis 1', description: 'An example funnel chart.', type: 'funnel', displayMode: 'chart', isBodyHidden: false, data: { labels: ['A', 'B', 'C'], values: [100, 50, 20] }, createdAt: yesterday, updatedAt: now },
      { id: 'chart-2', title: 'Sample Behavior Analysis 2', description: 'An example behavior chart.', type: 'behavior', displayMode: 'chart', isBodyHidden: false, data: { labels: ['X', 'Y', 'Z'], values: [10, 30, 15] }, createdAt: yesterday, updatedAt: now },
      { id: 'chart-3', title: 'Sample Rfm Analysis 3', description: 'An example RFM chart.', type: 'rfm', displayMode: 'chart', isBodyHidden: false, data: { type: 'heatmap', xLabels: ['1', '2'], yLabels: ['A', 'B'], values: [[5, 15], [25, 10]] }, createdAt: yesterday, updatedAt: now },
    ],
    isPinned: true,
    createdAt: yesterday,
    updatedAt: now
